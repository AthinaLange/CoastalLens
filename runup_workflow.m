...
switch camera_type
    ...
    case 'ARGUS'
        ...
        day_files(contains({day_files.name}, 'Processed_data'))=[];
        ...
        processed_files(~contains({processed_files.name}, 'runup'))=[];
...
switch answer
    case 'Yes'
        ...
        sendmail(user_email{2}, 'UAV Toolbox test email', [user_email{1} ' is processing ARGUS data from ' {day_files.name} ''])
...
%% ====================================================================
%                           runup SegFormer - Buscombe et al. 2024
%                           - extracts runup line from timestacks
%  =====================================================================
% 

%% ====================================================================
%                           runup rectified images - Salatin et al. 2024
%                           - extracts runup line from grid
%  =====================================================================
%
