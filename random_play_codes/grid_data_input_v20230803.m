...
%% 
% Send email with images - NEED TO FIX OUTPUT TO FIT WITH PRODUCTS STRUCTURE
        ...
        for pp = ids_grid
            ...
            grid_plot{pp} = [odir 'Processed_data/' oname '_' char(string(pp)) '_Grid_Local.png' ];
        end
        for pp = ids_xtransect
...
%%
    ...
    sendmail(user_email{2}, [oname '- Input Data'], ...
        grid_text, ...
        {[odir 'Processed_data/undistortImage.png'], ...
        grid_plot})
